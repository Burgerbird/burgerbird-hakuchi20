const DEFAULT_HEIGHT = window.screen.width * window.devicePixelRatio;
const DEFAULT_WIDTH = window.screen.height * window.devicePixelRatio;
...
export default class MainMenu extends Phaser.Scene {
    ...
    create(){
        ...
        let heightEach = DEFAULT_WIDTH/10;
        let ogY = 20;

        let widthEach = DEFAULT_HEIGHT/10;
        let ogX= 40;
        ...
        c=this.add.container(ogX+widthEach,ogY, [this.buttons[5], this.texts[5]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(ogX+widthEach,ogY+heightEach, [this.buttons[6], this.texts[6]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(ogX+widthEach,ogY+heightEach*2, [this.buttons[7], this.texts[7]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(ogX+widthEach,ogY+heightEach*3, [this.buttons[8], this.texts[8]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(ogX+widthEach,ogY+heightEach*4, [this.buttons[9], this.texts[9]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(ogX+widthEach*2,ogY, [this.buttons[10], this.texts[10]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(ogX+widthEach*2,ogY+heightEach, [this.buttons[11], this.texts[11]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(ogX+widthEach*2,ogY+heightEach*2, [this.buttons[12], this.texts[12]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(ogX+widthEach*2,ogY+heightEach*3, [this.buttons[13], this.texts[13]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(ogX+widthEach*2,ogY+heightEach*4, [this.buttons[14], this.texts[14]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(ogX+widthEach*3,ogY, [this.buttons[15], this.texts[15]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(ogX+widthEach*3,ogY+heightEach, [this.buttons[16], this.texts[16]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(ogX+widthEach*3,ogY+heightEach*2, [this.buttons[17], this.texts[17]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(ogX+widthEach*3,ogY+heightEach*3, [this.buttons[18], this.texts[18]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(ogX+widthEach*3,ogY+heightEach*4, [this.buttons[19], this.texts[19]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(ogX+widthEach*4,ogY, [this.buttons[20], this.texts[20]])
            .setSize(95,25)
            .on('pointerup',() => {
