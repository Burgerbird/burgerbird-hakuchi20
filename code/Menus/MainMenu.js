export default class MainMenu extends Phaser.Scene {
    ...
    create(){
        ...
        let c=this.add.container(150,80, [this.buttons[0], this.texts[0]])
            .setSize(95,25)
            .on('pointerup',() => {
                let map =
        ...
        c=this.add.container(150,120, [this.buttons[1], this.texts[1]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(150,160, [this.buttons[2], this.texts[2]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(150,200, [this.buttons[3], this.texts[3]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(150,240, [this.buttons[4], this.texts[4]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(150,280, [this.buttons[5], this.texts[5]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(150,320, [this.buttons[6], this.texts[6]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(350,80, [this.buttons[7], this.texts[7]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(350,120, [this.buttons[8], this.texts[8]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(350,160, [this.buttons[9], this.texts[9]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(350,200, [this.buttons[10], this.texts[10]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(350,240, [this.buttons[11], this.texts[11]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(350,280, [this.buttons[12], this.texts[12]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(350,320, [this.buttons[13], this.texts[13]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(535,80, [this.buttons[14], this.texts[14]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(535,120, [this.buttons[15], this.texts[15]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(535,160, [this.buttons[16], this.texts[16]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(535,200, [this.buttons[17], this.texts[17]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(535,240, [this.buttons[18], this.texts[18]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(535,280, [this.buttons[19], this.texts[19]])
            .setSize(95,25)
            .on('pointerup',() => {
        ...
        c=this.add.container(535,320, [this.buttons[20], this.texts[20]])
            .setSize(95,25)
            .on('pointerup',() => {
